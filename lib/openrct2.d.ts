...
declare global {
  ...
  interface Ride {
    ...
    /**
     * The types of track segments which this ride can build.
     */
    readonly trackSegments: AvailableTrackSegments;
  }
  ...
  /**
   * The lists of {@link TrackSegment} types which a ride is able to build. Includes standard segments, extras (which are technically drawable for the track type), and covered versions.
   */
  type AvailableTrackSegments = {
    /**
     * Segments that are drawable and appropriate for the ride type, (e.g. Monorail can build the Flat track segment).
     */
    enabled: number[];
    /**
     * Segments that this ride type _can_ draw, but which are disabled because their vehicles lack the relevant sprites, or because they are not realistic for the ride type (e.g. LIM boosters in Mini Roller Coasters).
     */
    extra: number[];
    /**
